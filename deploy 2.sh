...
# Exemplo: ./deploy.sh https://github.com/usuario/whatsapp-clone.git master
...
# Criar credentials.json com as credenciais reais
log "Criando credentials.json com as credenciais..."
cat > public/credentials.json << 'EOF'
{
  "users": [
    {
  ...
  "api": {
    ...
    "baseUrl": "https://n8n.rosenbaum.adv.br/webhook/api",
